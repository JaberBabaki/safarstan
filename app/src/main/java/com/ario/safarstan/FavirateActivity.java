...
public class FavirateActivity extends AppCompatActivity {
  ...
  public void initView() {
    ...
    adapter = new AdapterJazebehItem(FavirateActivity.this, shar2);
  ...
  public void setUpItemNavigation() {
    ...
    messge.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Intent intent = new Intent(FavirateActivity.this, MessageActivity.class);
        FavirateActivity.this.startActivity(intent);
    ...
    about.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        final Dialog dialog2 = new Dialog(FavirateActivity.this);
